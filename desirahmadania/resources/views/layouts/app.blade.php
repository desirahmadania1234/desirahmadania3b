                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto"> 
                            ...
                            <li class="nav-item dropdown">
                                <a id="#" class="btn btn-lg btn-outline-danger" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                   DESI RAHMADANIA <span class="caret"></span>
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="btn btn-lg btn-outline-warning" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                   MENU UMUM <span class="caret"></span>
                                </a>
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="btn btn-lg btn-outline-success text-dark" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                   MENU UTAMA <span class="caret"></span>
                                </a>
